...
public class EditWindow extends JDialog {
    ...
    public EditWindow(Repository parent, int itemId, String name, double price, int quantity, String category) {
    ...
    private void handleSave() {
        ...
        try {
            ...
            try (Connection conn = DatabaseConnection.getConnection()) {
                String sql = "UPDATE product_list SET Item_name=?, Item_price=?, Item_quantity=?, Item_category=? WHERE Item_id=?";
            ...
            JOptionPane.showMessageDialog(this, "Price and Quantity must be numbers.", "Input Error",
